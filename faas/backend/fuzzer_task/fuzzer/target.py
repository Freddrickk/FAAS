...
class LinuxProcessStdinTarget(ServerTarget):
    ...
    def _get_registers_report(self):
        ...
        report.add('rax', "0x{:x}".format(regs.rax))
        report.add('rbx', "0x{:x}".format(regs.rbx))
        report.add('rcx', "0x{:x}".format(regs.rcx))
        report.add('rdx', "0x{:x}".format(regs.rdx))
        report.add('rsi', "0x{:x}".format(regs.rsi))
        report.add('rdi', "0x{:x}".format(regs.rdi))
        report.add('r8', "0x{:x}".format(regs.r8))
        report.add('r9', "0x{:x}".format(regs.r9))
        report.add('r10', "0x{:x}".format(regs.r10))
        report.add('r11', "0x{:x}".format(regs.r11))
        report.add('r12', "0x{:x}".format(regs.r12))
        report.add('r13', "0x{:x}".format(regs.r13))
        report.add('r14', "0x{:x}".format(regs.r14))
        report.add('r15', "0x{:x}".format(regs.r15))
        report.add('rbp', "0x{:x}".format(regs.rbp))
        report.add('rsp', "0x{:x}".format(regs.rsp))
        report.add('rip', "0x{:x}".format(regs.rip))
